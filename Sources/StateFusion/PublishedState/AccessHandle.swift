...
//    @_unsafeSelfDependentResult
//    mutate {
//      __isMutablyAccessedFlag = true
//      return unsafe &_pointer.pointee
//    }
//  }
//
//  @usableFromInline
//  internal var isMutablyAccessed: Bool {
//    consuming get { __isMutablyAccessedFlag }
//  }
//
//  private var __isMutablyAccessedFlag: Bool = false
//
//  @usableFromInline
//  internal let _pointer: UnsafeMutablePointer<StateEntity>
//
//  @_alwaysEmitIntoClient
//  @_lifetime(borrow pointer)
//  @_transparent
//  internal init(pointer: UnsafeMutablePointer<StateEntity>) {
//    _pointer = pointer
//  }
// }
//
